  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 mt-4">
      <input
        ...
        className="w-full sm:w-4/5 p-3 placeholder-gray-400 text-gray-900 bg-white/80 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:bg-white dark:focus:bg-gray-900 transition-all duration-300 ease-linear rounded-xl shadow-md"
      />
      <button
        type="submit"
